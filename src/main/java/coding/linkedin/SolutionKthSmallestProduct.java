...
public class SolutionKthSmallestProduct {
    ...
    public static void main(String[] args) {
        SolutionKthSmallestProduct sol = new SolutionKthSmallestProduct();
        System.out.println(sol.kthSmallestProduct(new int[]{1,7}, new int[]{2,3,4}, 4)); // 14
        System.out.println(sol.kthSmallestProduct(new int[]{-4,-2,0,3}, new int[]{2,4}, 6)); // 0
        System.out.println(sol.kthSmallestProduct(new int[]{-6,-4,-3,0,1,3,4,7}, new int[]{-5,2,3,4}, 40)); // 147
    }
}
